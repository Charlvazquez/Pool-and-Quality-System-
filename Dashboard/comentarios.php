...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Comentarios recibidos</li>
              <li class="breadcrumb-item active">Comentarios por Categorias</li>
            </ol>
            <hr>
            <div class="row">
              ...
              <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#creaReporte"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exportar Reporte</button>
            	...
            	<div class="table-responsive col-xl-12">
                    <table  class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                              <?php               
                              require 'comentariosActions/comentario.php';
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                	<form action="../reportes/reporteComentariosCategoria.php" method="post" target="_blank">
                		<div class="row">
	                    	<div class="col-xl-3">
                        		<div class="form-group">
                    	        	<div class="input-group-prepend">
                                  <select name="categoriaPa" id="CATEGORIAPA" class="form-select" aria-label="Default select example">
