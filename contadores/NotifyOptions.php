...
<div class="wrapper">
 ...
 <?php require '../Dashboard/components/navbar.php';
  ...
  <div class="container-fluid">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Listado de opiniones Muy Malas de Pacientes</li>
                    ...
                    <tbody>
                        <?php
                            ...
                            INNER JOIN preguntas Pre ON Re.id_pregunta = Pre.id_pregunta
                                    INNER JOIN categoria Ca ON Re.id_categoria = Ca.id_categoria  WHERE Respuesta IN('Regular','Malo','Muy Malo') ";
