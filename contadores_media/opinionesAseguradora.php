...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../media/icon.png" alt="AdminLTELogo" height="60" width="60">
  </div>-->
  ...
  <div class="container-fluid">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Listado de opiniones Buenas de Pacientes</li>
            ...
            <div class="row">
            	<div class="table-responsive col-xl-12">
                    <table  class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                <?php require 'Queries/aseguradora.php';?>
                <?php
